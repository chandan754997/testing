...
// V 1.7     SM    (TCS)    R2012.1 - BDFR - Address de Facturation
// V 1.8     SM    (TCS)    R2012.1 - Defect Fix 299
//=============================================================================
...
const  // PVCS-keywords
  ...
  CtTxtSrcDate    = '$Date: 2013/01/24 13:58:36 $';
...
begin  // of TFrmDetManInvoiceCA.FillCustomerCaption
 ...
 try
   ...
   DmdFpnUtils.QueryInfo (#10' SELECT Address.TxtName '+
                          ...
                          #10' Where Customer.IdtCustomer = '  + inttostr(IdtCustomer) +
                          #10' AND Customer.CodCreator = '  + inttostr(CodCreator) +
  ...
  try
    ...
    SvcMECustomerName.Text := ViTxtCustomerName;                                          //R2012.1 Defect Fix 299(SM)
