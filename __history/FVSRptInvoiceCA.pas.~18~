...
// 1.49     ARB  (TCS)   Intracom Invoice Excl. Tax, ARB, R2011.1.EUR5
// 1.50     KB   (TCS)   Bug #181, KB,  R2011.1.EUR5
// 1.51     ARB  (TCS)   Intracom Invoice Excl. Tax, ARB, R2011.1.EUR5.Del1
// 1.52     ARB  (TCS)   Intracom Invoice Excl. Tax, ARB, R2011.1.EUR5.Del1.1
// 1.53     ARB  (TCS)   Intracom Invoice Excl. Tax, ARB, R2011.1.EUR5.Del2
// 1.54     ARB  (TCS)   Intracom Invoice Excl. Tax, ARB, R2011.1.EUR5.Del4
// 1.55     ARB  (TCS)   Intracom Invoice Excl. Tax, ARB, R2011.1.EUR5.Del5
// 1.56     KB   (TCS)   Bug #181 Fix, KB, R2011.1.EUR5
// 1.57     ARB  (TCS)   Intracom Invoice Excl. Tax, ARB, R2011.1.EUR5.Del6
// 1.58     ARB  (TCS)   CAFR.2011.2.23.9.1
// 1.59     ARB  (TCS)   CAFR.2011.2.23.9.2
// 1.60     SMB  (TCS)   Applix 2141096 & Defect 448
// 1.61     TT   (TCS)   R2012.1 - BRES - Format de facture
// 1.62     SM   (TCS)   Address de Facturation      SM ,R2012.1 
...
// 1.64     SRM  (TCS)   Applix 2281911 TCS(SRM)
// 1.65     SC   (TCS)   R2012.1 Defect Fix 39
// 1.66     SM   (TCS)   R2012.1 Defect Fix 88
// 1.67     SRM  (TCS)   R2011.2(Adhoc).ID17303.EcoTaxREPMOB-BDFR/CAFR.TCS-SRM
// 1.68     SM/CP(TCS)   R2013.1-11227-CAFR/BDES-Add store number in barcode
// 1.69     SRM  (TCS)   R2012.1-HPQC.DefectFix(298)
// 1.70     SM   (TCS)   R2012.1 Defect Fix 299
// 1.71	    TK	 (TCS)   R2012.1 Defect Fix 355- Russian Invoice
// 1.72     SM   (TCS)   R2012.1 Defect Fix 364
// 1.73     SM   (TCS)   R2013.1 HPQC Defect Fix 120
// 1.74		  SM	 (TCS)   R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices
// 1.75     CP   (TCS)   R2013.2.Applix(2805684).BDFR.Customer name of invoice problem
// 1.76		  SC	 (TCS)	 R2013.2.Req(25020).BRFR-CAFR.Entering Customer Info
// 1.77     CP   (TCS)	 R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices
// 1.78     AJ   (TCS)   R2014.1.Req(46020).BDES.Replace abono by Factura Rectificativa.TCS-AJ
// 1.79	    JD	 (TCS)	 R2013.2.ALM DEFECT 60.Req(31170).CAFR/BDFR.Legal Information On Invoices
// 1.80     JD	 (TCS)	 R2013.2.ALM DEFECT 62.Req(31170).CAFR/BDFR.Legal Information On Invoices
// 1.81     JD   (TCS)   R2013.1 Applix(2730906).Printing invoice problem-JD
// 1.82     MeD  (TCS)   R2013.2.ALM Defect Fix 134.CAFR.
// 1.83     MeD  (TCS)   R2013.2.Enhancement 138.BRFR.
// 1.84     Med  (TCS)   R2014.1.Req(45010).ALLOPCO.Improved Invoice Address For Duplication.
// 1.85     CP   (TCS)   R2013.2.Defect134/197.CAFR.LegalInfoinInvoice
// 1.86     JD   (TCS)   R2014.2.Req.55030.Invoice_and_Customer_entry.BDFR
// 1.87     MeD  (TCS)   R2014.1.Req(41070).CAFR.Print_Of_FidelityCard_Number
// 1.88	    JD	 (TCS)   R2014.1 ALM defect 287.BDES.A4 invoice issue1.88
// 1.89     AJ   (TCS)   R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-AJ
// 1.90     PS   (TCS)   R2014.1-CAFR-Audit_Point_HotFix-Invoice expiry date
//======================================================================================
...
uses
  ...
  ExtCtrls,ToolWin, MMntInvoice, FVSRptInvoice, StBarC, StDate, DBTables,                  // BDES - Invoice with bar code, PRG, R2012.1 - barcode component
  DateUtils;																			                              //R2014.1-CAFR-Audit_Point_HotFix-Invoice expiry date-TCS-PS	
...
var    // Column-width (in number of characters)
  ViValRptWidthDescrRemPers    : Integer = 32;                                  //R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-AJ
  ...
  CIFNLogConfig         : string = '\Logging\Installdl71.log';   //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
  ViValRptWidthMOBDescr : Integer = 38;// Width columns mobline description     //R2011.2(Adhoc)-Eco Tax REP MOB-BDFR/CAFR-SRM(TCS)
//  ViValRptWidthQty      : Integer = 6; // Width columns quantity
  ...
  CodInvoice          : integer;                                                //R2013.1-11227-CAFR/BDES-Add store number in barcode-TCS(SM/CP)
  ViValPageNumberPos  : integer;                                                //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
    
  //R2014.1.Req(45010).ALLOPCO.Improved-Invoice-Address-For-Duplication.TCS-Med.Start
  // For inserting delivery address details in postranscust table
  TxtDelivName : string;
  TxtDelivStreet : string;
  TxtDelivZipcod : string;
  TxtDelivCountry : string;
  TxtDelivMunicip : string;
  TxtDelivProvince : string;
  //R2014.1.Req(45010).ALLOPCO.Improved-Invoice-Address-For-Duplication.TCS-Med.End
  NumLineRegTemp  : Integer=0;              //R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-RC
  NumLineRegPrevious : Integer =0 ;         //R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-RC
//=============================================================================
...
resourcestring
  ...
  CtTxtInvoiceOrigin     = 'Invoice corresponding with ticket %s made on ' +
                           'caskdesk %s on %s';
  CtTxtOriginalInvoice     = 'Original invoice Number';							// R2014.1.Req(46020).BDES.Replace abono by Factura Rectificativa.TCS-AJ
  CtTxtCreditNoteNr        = 'Creditnote number';
  CtTxtCopyInvoice         = 'Copy of invoice';
  CtTxtInvoiceCreditnote   = 'Invoice/Creditnote Nr';
  CtTxtOriginalInvoiceNr   = 'Original invoice number';                         // R2014.1.Req(46020).BDES.Replace abono by Factura Rectificativa.TCS-AJ
  CtTxtOriginalInvoiceDate = 'Original invoice date';                           // R2014.1.Req(46020).BDES.Replace abono by Factura Rectificativa.TCS-AJ
...
//=============================================================================
// Boolean varibles to handle print greentax line
//=============================================================================
var
flgECOTax :Boolean;
flgECOFreeTax : Boolean;
flgMOBTax   : Boolean ;
flgMOBFreeTax   : Boolean ;
...
type
  ...
  public
    ...
    PrcD3E              : currency;
    CodTypeD3E          : Integer;
    PrcMOB              : currency;                                             //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM
    CodTypeMOB          : Integer;                                              //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM
...
type
  TFrmVSRptInvoiceCA = class(TFrmVSRptInvoice)
    ...
    QryRemisePerso: TQuery;
    QryRemisePersoTotal: TQuery;                                                 
  ...
  private
    ...
    FValTotalMOBTaxArticle     : currency;                                      //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM
    FValTotalMOBTaxFreeArticle : currency;                                      //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM
    ...
    FCodCreator        : Integer;
    FNumCopies         : Integer;
    FNumQtyCopy        : Integer;         //R2013.1 Applix(2730906).Printing invoice problem-JD
  ...
  protected
    ...
    TxtTableBodyFmtMOB  : string;      // Format for body line mobtax on report //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM
    ...
    function GenerateLineMOBTax : string; virtual;                              //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start
    function GenerateLineBothMOBTax : string; virtual;                          
    function GenerateLineBothECOTax : string; virtual;                          //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End
    ...
    procedure PrintLineMOBTax; virtual;                                         //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start
    procedure PrintLineBothECOTax; virtual;                                     
    procedure PrintLineBothMOBTax; virtual;                                     //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End   
    ...
    property NumCopies : Integer read FNumCopies
                                 write FNumCopies;
    property NumQtyCopy : Integer read FNumQtyCopy                              //R2013.1 Applix(2730906).Printing invoice problem-JD
                                 write FNumQtyCopy;
  ...
  public
    ...
    property ValTotalMOBTaxArticle: Currency read FValTotalMOBTaxArticle
                                            write FValTotalMOBTaxArticle;
    property ValTotalMOBTaxFreeArticle: Currency read FValTotalMOBTaxFreeArticle
                                               write FValTotalMOBTaxFreeArticle;
    //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End  ::::
    ...
    //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.START
    procedure PrintHeadOfficeInfo;
    function  AddThousandSeparator(S: string; Chr: Char):string;
    procedure GetFooterInfo;
    procedure PrintBankInfoBDFR;
    function  GetFileModDate(filename : string):Tdatetime;
    //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.END
...
var
  ...
  //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.START
  FooterTextPaymentHdr:string;
  FooterTextVAT : string;
  FooterInformation:string;
  FooterTextAddpayment :string;
...
uses
  ...
  StStrW,
  StDateSt,                                                                     // R2014.1.Req(46020).BDES.Replace abono by Factura Rectificativa.TCS-AJ
  SmUtils,
  SmDBUtil_BDE,
  SfDialog,
  ...
  DMDummy,
  DMDummyCA,
  FVWPosJournal,                                                                //R2013.1-11227-CAFR/BDES-Add store number in barcode-TCS(SM/CP)
  FVWPosJournalCA,                                                              //R2013.1-11227-CAFR/BDES-Add store number in barcode-TCS(SM/CP)
  DfpnInvoiceCA,                                                                //R2013.1-11227-CAFR/BDES-Add store number in barcode-TCS(SM/CP)
  DfpnUtilsCA,                                                                  //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
  ActiveX,
  AXCtrls,
...
const  // PVCS-keywords
  ...
  CtTxtSrcVersion = '$Revision: 1.90 $';
  CtTxtSrcDate    = '$Date: 2015/07/01 13:10:13 $';
...
begin  // of TObjTransactionCA.FillObj
  ...
  case DsrData.FieldByName ('CodAction').AsInteger of
    ...
    CtCodActPLUNum, CtCodActPLUKey, CtCodActClassNum, CtCodActClassKey, CtCodActGiftCard,
    CtCodErrGiftCard : begin                                                    //R2011.2 TCS SMB Applix 2141096  //R2011.2 Defect 448 TCS SMB
      // Fill in the action
      ...
      //R2011.2 Defect 448 TCS SMB Start
        else if CodActTurnOver = CtCodErrGiftCard then begin
          TxtDescrTurnOver := CtTxtCarteCadeau;
          NumPLU := DsrData.FieldByName ('NumPLU').AsVariant;
          IdtArticle := DsrData.FieldByName ('NumPLU').AsString
        end
      //R2011.2 Defect 448 TCS SMB End
        else begin
    ...
    CtCodActCoupPayment, CtCodActSavingCard, CtCodRoundTick: begin              // R2012.1 Defect Fix 355- Russian Invoice - TCS(TK)
      if CodMainAction = 0 then
        CodMainAction := DsrData.FieldByName ('CodAction').AsInteger;
      CodActAdm := DsrData.FieldByName ('CodAction').AsInteger;
    ...
    CtCodActComment : begin
      ...
      //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start :::
      if (DsrData.FieldByName('CodType').AsInteger = CtCodPdtCommentMOBTaxArticle)
      or (DsrData.FieldByName('CodType').AsInteger = CtCodPdtCommentMOBTaxFreeArticle)
      then begin
        CodTypeMOB := DsrData.FieldByName('CodType').AsInteger;
        PrcMOB := DmdFpnUtils.ExchangeCurr
          (DsrData.FieldByName('PrcInclVAT').AsCurrency, ValExchangeOrig,
           FlgExchMultiplyOrig, DmdFpnUtils.ValExchangeBase,
           DmdFpnUtils.FlgExchMultiplyCurrencyMain);
      end; // of if (DsrData.FieldByName('CodType').AsInteger....
...
begin  // of TFrmVSRptInvoiceCA.AppendFmtAndHdrCodeCasto
  if TxtTableBodyFmt <> '' then begin
    ...
    TxtTableBodyFmtMOB := TxtTableBodyFmtMOB + SepCol;                          //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM
                 ...
                 Format ('%s%d',
                         [FormatAlignRight,
                          ColumnWidthInTwips(CharStrW('0',
                                                     ViValRptWidthCodeCasto))]);
  //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start :::::
  TxtTableBodyFmtMOB := TxtTableBodyFmtMOB +
                 Format ('%s%d',
                         [FormatAlignRight,
                          ColumnWidthInTwips(CharStrW('0',
                                                     ViValRptWidthCodeCasto))]);
...
begin  // of TFrmVSRptInvoiceCA.BuildTableBodyFmtAndHdr
  TxtTableBodyFmt := '';
  TxtTableBodyFmtD3E := '';
  TxtTableBodyFmtMOB := '';                                                     //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM
  TxtTableBodyHdr := '';
  TxtTableBodyHdr2 := '';
  ...
  if not FlgRussia then begin
    ...
    if FlgEmplCard then
      TxtTableBodyFmt := TxtTableBodyFmt + SepCol +
                         Format ('%s%d', [FormatNoWrap + FormatAlignLeft,
                                       ColumnWidthInTwips (ViValRptWidthDescrRemPers)])
    else if FlgClientIntracom then
    ...
    //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start
    TxtTableBodyFmtMOB := TxtTableBodyFmtMOB + SepCol +
                       Format ('%s%d', [FormatNoWrap + FormatAlignLeft,
                                   ColumnWidthInTwips (ViValRptWidthEcoDescr)]);
    //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End
    ...
    // Intracom Invoice excl. Tax, ARB, R2011.1.EUR5, End
    if not FlgEmplCard then                                                     //R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-AJ
...
var
  ...
  // BDES - Invoice with bar code, PRG, R2012.1 - end
//R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.Start 
  TxtSiretLabel    : string;
  TxtSiretValue    : string;
  TxtIBANLabel     : string;
  TxtIBANValue     : string;
  TxtVatValue      : string;
  TxtDatTransBegin : TDateTime;
//R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.End           
...
begin  // of TFrmVSRptInvoiceCA.PrintGeneralInfo
      ...
      if DmdFpnUtils.QueryInfo ('SELECT TxtMemo FROM TradeMatrix ' +
        ...
        try
          for CntIndex := 0 to Pred (StrLstMemo.Count) do begin
            if not ViFlgCAFR then begin                                         //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
              VspPreview.Text:= StrLstMemo.Strings[CntIndex];
              VspPreview.Text := #10;
            end;                                                                //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
          end;
        finally
          StrLstMemo.free;
        end;
  ...
  //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.START
  if ViFlgCAFR then begin
    try
      VspPreview.Text := #10 +  #10;
      if DmdFpnUtils.QueryInfo(
      #10'SELECT IdtApplicParam,TxtParam FROM ApplicParam' +
      #10'WHERE IdtApplicParam in' +
      #10'(''StoreLabelSiret'',''StoreSiret'',''StoreLabelIban'',''StoreIban'',''HeadOVat'')')  then begin
        with DmdFpnUtils.QryInfo do begin
          if Locate ('IdtApplicParam','StoreLabelSiret',[loCaseInsensitive]) then
            TxtSiretLabel := FieldByName ('TxtParam').AsString;
          if Locate ('IdtApplicParam','StoreSiret',[loCaseInsensitive]) then
            TxtSiretValue := FieldByName ('TxtParam').AsString;
          if Locate ('IdtApplicParam','StoreLabelIban',[loCaseInsensitive]) then
            TxtIBANLabel := FieldByName ('TxtParam').AsString;
          if Locate ('IdtApplicParam','StoreIban',[loCaseInsensitive]) then
            TxtIBANValue := FieldByName ('TxtParam').AsString;
          if Locate ('IdtApplicParam','HeadOVat',[loCaseInsensitive]) then
            TxtVATValue := FieldByName ('TxtParam').AsString;
        end;
      end;
    finally
    ...
    VspPreview.Text:=copy(TxtSiretLabel,3,length(TxtSiretLabel)) + ' ' + TxtSiretValue + #10;   //R2013.2.Defect134/197.CAFR.LegalInfoinInvoice.TCS-CP
    CreationDate:=(FileGetCreationDate(CIFNLogConfig));
    TxtDatTransBegin:=(DsrPOSTransIdts.DataSet.
                          FieldByName('DatTransBegin').AsDateTime);
    if TxtDatTransBegin > CreationDate then
      VspPreview.Text:= TxtIBANLabel + ' ' + TxtIBANValue + #10;          //R2013.2.Defect134/197.CAFR.LegalInfoinInvoice.TCS-CP
      VspPreview.Text:= TxtVATValue + #10;
  end; 
  //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.END
  ...
  if FlgManInvoice then begin
    if (DmdFpnInvoice.LstTickets.Count=1) and (ViFlgBcdManInv) then begin
  ...
  else if (DmdFpnInvoice.LstTickets.Count=1) and (ViFlgBcdA4Inv) then begin     //R2013.1-11227-CAFR/BDES-Add store number in barcode-TCS(SM/CP)
    DatTransBegin := DateTimeToStDate(TObjTransTicket
                       (DmdFpnInvoice.LstTickets[CntTickets]).DatTransBegin);
    NumTicket     := TObjTransTicket
                       (DmdFpnInvoice.LstTickets[CntTickets]).IdtPOSTransaction;
...
//R2014.1-CAFR-Audit_Point_HotFix-Invoice expiry date-TCS-PS-Start
  NumInvExpDays    : integer;          //Number of days before expiry//preeti
  DatInvoice       : TDateTime;        
  DatExpiry        : TDateTime;        
  DatExpiryShown   : TDateTime;        
  myYear, myMonth, myDay : Word;       
//R2014.1-CAFR-Audit_Point_HotFix-Invoice expiry date-TCS-PS-End
begin  // of TFrmVSRptInvoiceCA.PrintGeneralInvoiceInfo
  //R2014.1-CAFR-Audit_Point_HotFix-Invoice expiry date-TCS-PS-Start
  if ViPrintInvoiceExpiry and FlgClientEnCompte then
  begin
  ...
  if CodKind = CodKindDelivNote then begin
      ...
      if not FlgRussia then
        if FlgItaly then
          VspPreview.Text := CtTxtCreditNoteNr + ': ' + TxtTradeMatrix + ' ' +
                             TxtNumber + #10
        // R2014.1.Req(46020).BDES.Replace abono by Factura Rectificativa.TCS-AJ.Start
        else if ViFlgAllowChangeCredNote then
          VspPreview.Text := CtTxtCreditNoteNr + ': ' + TxtNumber + ''
        // R2014.1.Req(46020).BDES.Replace abono by Factura Rectificativa.TCS-AJ.End
        else
    ...
    if not FlgRussia then begin
      ...
      if ViPrintInvoiceExpiry and FlgClientEnCompte then
      begin
        if ViInvExpLastDayOfMon then
        begin
          if NumInvExpdays <> 0 then
            DatExpiry:= DatInvoice + NumInvExpDays;
          DecodeDate(DatExpiry, myYear, myMonth, myDay);
          DatExpiryShown:= EndofAMonth(myYear,myMonth);
          VspPreview.Text :=  CtTxtInvDateExpiry + ' ' +
                              DateToStr (DatExpiryShown) + #10
        end
        else
        begin
           DatExpiry:= DatInvoice + NumInvExpDays;
           VspPreview.Text :=  CtTxtInvDateExpiry + ' ' +
                            DateToStr (DatExpiry) + #10
        end;
      end;
      //R2014.1-CAFR-Audit_Point_HotFix-Invoice expiry date-TCS-PS-End
      
    // R2014.1.Req(46020).BDES.Replace abono by Factura Rectificativa.TCS-AJ.Start
    if ViFlgServerAvailable and ViFlgAllowChangeCredNote and (FrmVWPosJournalCA.
            FlgReturnTicket) then begin
      try
        if DmdFpnUtils.QueryInfo(DmdFpnPosTransactionCA.
                                   BuildSQLPOSTransDetInvoiceDoc
                                    (IdtPosTransactionOrig,IdtCheckOutOrig,
                                       DatOrigTickDatTime)) then begin
          TempIdtInvoice := DmdFpnUtils.QryInfo.FieldByName ('Idtinvoice').
                            AsString;
          TempDatInvoice := DmdFpnUtils.QryInfo.FieldByName ('Datinvoice').
                            AsString;
        end
        else
        begin
      ...
      if (not FlgFiscal) and (FlgInvForm) and (TempDatInvoice <> '') and
           (TempIdtInvoice <> '') and
             (FrmVWPosJournalCA.FlgReturnTicket) then begin
        VspPreview.Text := CtTxtOriginalInvoiceNr + ': ' + TxtTradeMatrix + '-' +LeftPadStringCh
                            ((TempIdtInvoice),'0',7) + #10;
        SplitString(TempDatInvoice, ' ', TempDatInvoice, TxtTime);
        Dattick := DateStringToStDate(CtTxtDatFormat,(TempDatInvoice),CtValEpoch);
        if (not FlgFiscal) and (FlgInvForm) then
        VspPreview.Text := CtTxtOriginalInvoiceDate + ': ' + TempDatInvoice + #10;
      end;
    end;
     // R2014.1.Req(46020).BDES.Replace abono by Factura Rectificativa.TCS-AJ.End
    end;
  ...
  If not FlgRussia then begin
    ...
    if FlgItaly then
      VspPreview.CurrentX := ViValRptDupliPoxX;
      ViValPageNumberPos:= VspPreview.CurrentY;                                 //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
  end;
...
var
  ...
  TxtCountry       : string;           //R2014.2.Req(55030).BDFR.Invoice_and_Customer_entry.TCS-JD
  FlgProvince      : Boolean;
  TxtNumcard       : string;           //R2014.1.Req(41070).CAFR.Print_of_FidelityCard_Number.TCS-MeD
begin  // of TFrmVSRptInvoiceCA.PrintDeliveryNoteInfo
  ...
  try
    ...
    TxtCustName      := '';
    TxtCountry       := '';
    TxtNumcard       := '';           //R2014.1.Req(41070).CAFR.Print_of_FidelityCard_Number.TCS-MeD
...
//R2014.1.Req(41070).CAFR.Print_of_FidelityCard_Number.TCS-MeD.Start
if ViFlgCAFR then begin
  DmdFpnUtils.CloseInfo;
  if DmdFpnUtils.QueryInfo( 'SELECT Numcard' +
         #10' FROM PosTransaction (NOLOCK)' +
         #10' WHERE (IdtPosTransAction = ' + DsrPOSTransIdts.DataSet.
    ...
    TxtNumcard := DmdFpnUtils.QryInfo.FieldByName ('Numcard').AsString;
  end;
  DmdFpnUtils.CloseInfo;
end;	
//R2014.1.Req(41070).CAFR.Print_of_FidelityCard_Number.TCS-MeD.End
   if FlgFrance then begin                                                      // R2012.1 Address De facturation (SM) ::START
    if DmdFpnUtils.QueryInfo
       {(#10'SELECT ' +                                                         //R2013.2.Applix(2805684).BDFR.Customer name of invoice problem.TCS(CP).start
        #10'  TxtName,' +                                                       // R2012.1 Defect Fix 299
        #10'  TxtStreet,' +
        #10'  Municipality.TxtCodPost,' +
        #10'  rtrim(Municipality.TxtName) as TxtMunicip ' +
        ...
        #10'  Postranscust.TxtStreet,' +
        #10'  Postranscust.TxtCodPost,' +
        #10'  Postranscust.TxtCountryDelivAdd,' +    //R2014.2.Req(55030).BDFR.Invoice_and_Customer_entry.TCS-JD
        #10'  rtrim(Postranscust.TxtMunicip) as TxtMunicip ' +
        #10 + Trim(TxtFldProvince) + ' ' +
        #10'FROM ' +
        #10'  POSTransCust ' +
        #10' Inner Join Address ON ' +
        #10' Postranscust.IdtCustomer = Address.IdtCustomer ' +                 //R2013.2.Applix(2805684).BDFR.Customer name of invoice problem.TCS(CP).End
        #10'WHERE ' +
	  ...
	  //R2014.2.Req(55030).BDFR.Invoice_and_Customer_entry.TCS-JD.Start
      if ViFlgBDFR and (CodCreator=4) then
      TxtCountry := DmdFpnUtils.QryInfo.FieldByName('TxtCountryDelivAdd').AsString;
	  //R2014.2.Req(55030).BDFR.Invoice_and_Customer_entry.TCS-JD.End
      if FlgProvince then
        TxtProvince := ' (' +
                DmdFpnUtils.QryInfo.FieldByName('TxtProvince').AsString + ')';
    end;
    end else begin                   // of if FlgFrance                         // R2012.1 Address De facturation (SM) ::END
    if DmdFpnUtils.QueryInfo
       (#10'SELECT ' +
        #10'  TxtName,' +
        #10'  TxtStreet,' +
  ...
  VspPreview.Text := TxtCountry + #10;        //R2014.2.Req(55030).BDFR.Invoice_and_Customer_entry.TCS-JD
...
var
  ...
  TxtSep           : string;
  FlgProvince      : Boolean;
  TxtCountry       : string;            //Country Name                          //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
  TxtNumcard       : string;            //R2014.1.Req(41070).CAFR.Print_of_FidelityCard_Number.TCS-MeD
begin  // of TFrmVSRptInvoiceCA.PrintInvoiceNoteInfo
  ...
  try
    ...
    TxtMunicip       := '';
    TxtProvince      := '';
    TxtProvinceUpd   := '';                         //Internal Defect Fix-MeD
    TxtVATCode       := '';
    TxtINN           := '';
    TxtKPP           := '';
    TxtOKPO          := '';
    TxtCompanyType   := '';
    TxtFldProvince   := '';
    TxtCountry       := '';  											 //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM 
    TxtNumcard       := '';                                          //R2014.1.Req(41070).CAFR.Print_of_FidelityCard_Number.TCS-MeD
    TxtDelivName     := '';											//Internal defect fix (JD).Start
    TxtDelivStreet   := '';
    TxtDelivZipcod   := '';
    TxtDelivCountry  := '';
    TxtDelivMunicip  := '';  											//Internal defect fix (JD).Start   
// defect fix (JD)                                      
    TxtDatTransBegin := AnsiQuotedStr (FormatDateTime (ViTxtDBDatFormat + ' ' +
                          ViTxtDBHouFormat, DsrPOSTransIdts.DataSet.
                          FieldByName('DatTransBegin').AsDateTime), '''');
...
//R2014.1.Req(41070).CAFR.Print_of_FidelityCard_Number.TCS-MeD.End
   if FlgFrance and (not FlgClientIntracom) then begin                                                        // R2012.1 Address De facturation (SM) ::START //FlgIntracom Clause added for R2012.1 Defect Fix 364
     if not FlgDuplicate or (idtcustomer = 0) or flgblnkcust then begin                                            //R2014.1.Req(45010).ALLOPCO.Improved-Invoice-Address-For-Duplication.TCS-Med( internal defect fix)
       if DmdFpnUtils.QueryInfo
         (#10'SELECT ' +
          #10'  POSTransCust.IdtCustomer, POSTransCust.CodCreator, Address.TxtName,  Address.TxtStreet,Municipality.TxtCodPost,' +       //R2012.1 System testing 1 Fix (SM)     //R2012.1 Defect Fix 88 (SM)
          #10'  Country.TxtName as TxtCountry,rtrim(Municipality.TxtName) as TxtMunicip, POSTransCust.TxtNumVAT, TxtINN, TxtKPP, TxtOKPO, TxtCompanyType ' +           //R2012.1 System testing 1 Fix (SM) //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.START
          Trim(TxtFldProvince) + ' ' +
          #10'FROM ' +
          #10' POSTransCust ' +
          #10' Inner Join Address ON ' +
          ...
          #10' Inner Join Municipality ON ' +
          #10' Address.IdtMunicipality = Municipality.IdtMunicipality ' +
          #10' Inner Join Country ON ' +
          #10' Municipality.IdtCountry = Country.IdtCountry ' +
          #10' WHERE ' +
          #10'  (IdtPOSTransaction = ' + DsrPOSTransIdts.DataSet.
            FieldByName ('IdtPOSTransaction').AsString + ')' +
        #10' AND (IdtCheckout = ' + DsrPOSTransIdts.DataSet.
        ...
        #10' AND (DatTransBegin = ' + TxtDatTransBegin + ')') then begin
          ...
          TxtCountry := DmdFpnUtils.QryInfo.FieldByName('TxtCountry').AsString;               //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
          TxtMunicip := DmdFpnUtils.QryInfo.FieldByName('TxtMunicip').AsString;
          ...
          //R2013.2.Req(25020).BRFR-CAFR.Entering Customer Info.TCS-SC.Start
          if IdtCustomer = 0 then begin
            if DmdFpnUtils.QueryInfo(#10'SELECT ' +
              #10'  Postranscust.IdtCustomer, Postranscust.CodCreator,' +
              #10'  Postranscust.TxtName,  Postranscust.TxtStreet,  Postranscust.TxtCodPost,' +
              #10'  TxtCountry, rtrim(POSTransCust.TxtMunicip) as TxtMunicip, Postranscust.TxtNumVAT, TxtINN, TxtKPP, TxtOKPO, TxtCompanyType ' +
                  Trim(TxtFldProvince) + ' ' +
              #10'FROM ' +
              #10' POSTransCust ' +
              #10' WHERE ' +
              ...
              #10' AND (DatTransBegin = ' + TxtDatTransBegin + ')') then begin
                ...
                TxtStreet  := DmdFpnUtils.QryInfo.FieldByName ('TxtStreet').AsString;
                TxtZipcod  := DmdFpnUtils.QryInfo.FieldByName('TxtCodPost').AsString;
                TxtCountry := DmdFpnUtils.QryInfo.FieldByName('TxtCountry').AsString;
                TxtMunicip := DmdFpnUtils.QryInfo.FieldByName('TxtMunicip').AsString;
                TxtVATCode := DmdFpnUtils.QryInfo.FieldByName('TxtNumVAT').AsString;
                IdtCustomer := DmdFpnUtils.QryInfo.FieldByName('IdtCustomer').AsInteger;
                if FlgProvince then
        ...
        //R2013.2.Req(25020).BRFR-CAFR.Entering Customer Info.TCS-SC.End
        if DmdFpnUtils.QueryInfo
          (#10'SELECT ' +
          #10'  Postranscust.IdtCustomer, Postranscust.CodCreator,' +
          #10'  Postranscust.TxtName,  Postranscust.TxtStreet,  Postranscust.TxtCodPost,' +   //R2013.2.Applix(2805684).BDFR.Customer name of invoice problem.TCS(CP).end
          #10'  Country.TxtName as TxtCountry, rtrim(POSTransCust.TxtMunicip) as TxtMunicip, Postranscust.TxtNumVAT, TxtINN, TxtKPP, TxtOKPO, TxtCompanyType ' +   //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
          Trim(TxtFldProvince) + ' ' +
          #10'FROM ' +
          #10' POSTransCust ' +
          #10' Inner Join Address ON ' +
        ...
        if FlgProvince then
          TxtProvince := ' (' +
                            DmdFpnUtils.QryInfo.FieldByName('TxtProvince').AsString + ')';
          TxtProvinceUpd := DmdFpnUtils.QryInfo.FieldByName('TxtProvince').AsString;           //Internal Defect Fix-MeD
        if FlgRussia then begin
          TxtINN         := DmdFpnUtils.QryInfo.FieldByName ('TxtINN').AsString;
          TxtKPP         := DmdFpnUtils.QryInfo.FieldByName ('TxtKPP').AsString;
          TxtOKPO        := DmdFpnUtils.QryInfo.FieldByName('TxtOKPO').AsString;
     ...
     end;                                                                        //R2014.1.Req(45010).ALLOPCO.Improved-Invoice-Address-For-Duplication.TCS-Med
   end
   //R2014.1.Req(45010).ALLOPCO.Improved Invoice Address For Duplication.TCS-Med.Start
     else begin
         if DmdFpnUtils.QueryInfo
         (#10'SELECT ' +
         #10'  Postranscust.TxtSrcNameDelivAdd,' +
         #10'  Postranscust.TxtStreetDelivAdd,' +
         #10'  Postranscust.TxtCodPostDelivAdd,' +
         #10'  rtrim(Postranscust.TxtMunicipDelivAdd) as TxtMunicipDelivAdd, POSTransCust.TxtNumVAT, TxtINN, TxtKPP, TxtOKPO, TxtCompanyType, TxtCountryDelivAdd' +
         #10 + Trim(TxtFldProvince) + ' ' +
         #10'FROM ' +
         #10'  POSTransCust ' +
         #10'WHERE ' +
         ...
         #10' AND (CodTrans = ' + DsrPOSTransIdts.DataSet.
            FieldByName ('CodTrans').AsString + ')' +
         #10' AND (DatTransBegin = ' + TxtDatTransBegin + ')') then begin
         TxtDelivName    := DmdFpnUtils.QryInfo.FieldByName ('TxtSrcNameDelivAdd').AsString;
         TxtDelivStreet  := DmdFpnUtils.QryInfo.FieldByName ('TxtStreetDelivAdd').AsString;
         TxtDelivZipcod  := DmdFpnUtils.QryInfo.FieldByName('TxtCodPostDelivAdd').AsString;  //R2012.1 System testing 1 Fix (SM)
         TxtDelivCountry := DmdFpnUtils.QryInfo.FieldByName('TxtCountryDelivAdd').AsString;  //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
         TxtDelivMunicip := DmdFpnUtils.QryInfo.FieldByName('TxtMunicipDelivAdd').AsString;
         TxtVATCode := DmdFpnUtils.QryInfo.FieldByName('TxtNumVAT').AsString;
           if FlgProvince then
             TxtDelivProvince := ' (' +
                DmdFpnUtils.QryInfo.FieldByName('TxtProvince').AsString + ')';
	 ...
	 if not FlgDuplicate then begin
         ...
         DmdFpnInvoiceCA.SetCustTrans (DsrPOSTransIdts.DataSet.FieldByName ('IdtPOSTransaction').AsInteger,
                        ...
                        IdtCustomer,CodCreator,TxtName,TxtStreet,
                        TxtZipcod,TxtMunicip,'',TxtCountry,'',0,TxtProvinceUpd);              //Internal Defect Fix-MeD
     end;
   //R2014.1.Req(45010).ALLOPCO.Improved Invoice Address For Duplication.TCS-Med. End
  end   // of if FlgFrance
  else begin                                            // R2012.1 Address De facturation (SM) ::END
    //R2013.2.Req(25020).BRFR-CAFR.Entering Customer Info.TCS-SC.Start
    if IdtCustomer = 0 then begin
      if DmdFpnUtils.QueryInfo(#10'SELECT ' +
        #10'  Postranscust.IdtCustomer, Postranscust.CodCreator,' +
        ...
        #10' AND (CodTrans = ' + DsrPOSTransIdts.DataSet.
            FieldByName ('CodTrans').AsString + ')' +
        #10' AND (DatTransBegin = ' + TxtDatTransBegin + ')') then
      begin
        TxtName    := DmdFpnUtils.QryInfo.FieldByName ('TxtName').AsString;
        TxtStreet  := DmdFpnUtils.QryInfo.FieldByName ('TxtStreet').AsString;
        TxtZipcod  := DmdFpnUtils.QryInfo.FieldByName('TxtCodPost').AsString;
    ...
    if DmdFpnUtils.QueryInfo
       (#10'SELECT ' +
        #10'  PostransCust.IdtCustomer,PostransCust.CodCreator,PostransCust.TxtName,' +
        #10'  PostransCust.TxtStreet,PostransCust.TxtCodPost,Postranscust.TxtCountry,' +                          //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
        #10'  TxtMunicip,PostransCust.TxtNumVAT, TxtINN, TxtKPP, TxtOKPO, TxtCompanyType ' +
        Trim(TxtFldProvince) + ' ' +
        #10' FROM ' +
        #10' POSTransCust ' +
        #10' Inner Join Address ON ' +
  ...
  if not FlgRussia then begin                            //R2014.1.Req(45010).BRFR.Improved Invoice Address For Duplication.TCS-Med
    if not FlgDuplicate or (Idtcustomer = 0) or( flgblnkcust )then begin           //Internal defect fix for enhancement 315 and manual invoice(JD/Med)
      VspPreview.Text := TxtName + #10;
      VspPreview.Text := TxtStreet + #10;
      VspPreview.Text := TxtZipcod + ' ' + TxtMunicip + TxtProvince + #10;
       if not ViFlgCAFR and not ViFlgBDFR then begin                              // ALM defect 287.BDES.A4 invoice issue.JD.Start
       VspPreview.Text := #10;
       VspPreview.CurrentY := VspPreview.CurrentY - 150;
       VspPreview.Text := CtTxtCustNumber + ' : ' + IntToStr (IdtCustomer) + #10;
       VspPreview.Text := CtTxtVATCode + ' : ' + TxtVATCode + #10;
       end ;                                                                        // ALM defect 287.BDES.A4 invoice issue.JD.End
        if ViFlgCAFR or ViFlgBDFR then begin                                              //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
          VspPreview.Text := TxtCountry + #10;                                      //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
      VspPreview.Text := #10;
      VspPreview.CurrentY := VspPreview.CurrentY - 150;
      VspPreview.Text := CtTxtCustNumber + ' : ' + IntToStr (IdtCustomer) + #10;
      VspPreview.Text := CtTxtVATCode + ' : ' + TxtVATCode + #10;
	  //R2014.1.Req(41070).CAFR.Print_of_FidelityCard_Number.TCS-MeD.start
      if TxtNumcard <> '' then
        VspPreview.Text := CtTxtCustomer + ' : ' + TxtNumcard + #10; 
	  //R2014.1.Req(41070).CAFR.Print_of_FidelityCard_Number.TCS-MeD.end	               
      // Intracom Invoice excl. Tax, ARB, R2011.1.EUR5, Start
    ...
    //                      ViValRptClientIntracomHeight, True, False, True);     // BDFR - Evol2
    //R2014.1.Req(45010).BRFR.Improved Invoice Address For Duplication.TCS-Med.Start 
	    end;
      end;
    end
    //R2014.1.Req(45010).BRFR.Improved Invoice Address For Duplication.TCS-Med.Start
    else if (FlgDuplicate) and (FlgClientIntracom) then begin
      VspPreview.Text := TxtName + #10;
      VspPreview.Text := TxtStreet + #10;
      VspPreview.Text := TxtZipcod + ' ' + TxtMunicip + TxtProvince + #10;
        if ViFlgCAFR or ViFlgBDFR then begin                                              //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
    ...
    end    // if (FlgDuplicate) and (FlgClientIntracom) end

    else begin
      VspPreview.Text := TxtDelivName + #10;
      VspPreview.Text := TxtDelivStreet + #10;
      VspPreview.Text := TxtDelivZipcod + ' ' + TxtDelivMunicip + TxtDelivProvince + #10;
        if ViFlgCAFR or ViFlgBDFR then                                              //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
          VspPreview.Text := TxtDelivCountry + #10;                                 //megh     //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
      VspPreview.Text := #10;
      VspPreview.CurrentY := VspPreview.CurrentY - 150;
      VspPreview.Text := CtTxtCustNumber + ' : ' + IntToStr (IdtCustomer) + #10;
      VspPreview.Text := CtTxtVATCode + ' : ' + TxtVATCode + #10;
      ...
      if FlgClientIntracom then begin                                              // BDFR - Evol2
        ...
        VspPreview.TextBox (' ' + TxtClientIntraLine2 + ' '
                          ...
                          VspPreview.CurrentY + 200, ViValRptClientIntracomWidth,     // ..
                          ViValRptClientIntracomHeight, True, False, True);     // BDFR - Evol2
	//R2014.1.Req(45010).BRFR.Improved Invoice Address For Duplication.TCS-Med.End					  
    // Intracom Invoice excl. Tax, ARB, R2011.1.EUR5, End
    // Commented as part of Intracom Invoice excl. Tax, ARB, R2011.1.EUR5
    //if IsClientIntraCom then begin                                              // BDFR - Evol2
    //  VspPreview.BrushStyle := bsTransparent;                                   // ..
    ...
    //                      VspPreview.CurrentY, ViValRptClientIntracomWidth,     // ..
    //                      ViValRptClientIntracomHeight, True, False, True);     // BDFR - Evol2
      end;																		  //R2014.1.Req(45010).BRFR.Improved Invoice Address For Duplication.TCS-Med
    end;
  end // of if not FlgRussia
  else begin
    //RUSSIA
...
var
  TxtQtyArt        : string;           // Converted qty article
  //R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-RC.Start
  RemisePersoTotal   : Double;
  DatTransbegin    : string;
  QtyTotalReturn   : Double;
  //R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-RC.End
begin  // of TFrmVSRptInvoiceCA.GenerateNormalLine
  ...
  if not FlgRussia then begin
    //R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-RC.Start
    if FlgEmplCard then begin
      QtyTotalReturn  := 0;
      DatTransbegin  := FormatDateTime('yyyy-mm-dd hh:mm:ss.000',ObjCurrentTicket.DatTransBegin);
      QryRemisePerso.Close;
      QryRemisePerso.SQL.Clear;
      RemisePersoTotal := 0;
      if ObjCurrentTrans.ValInclVAT < 0 then
       QryRemisePerso.SQL.Add('select Numlinereg, Qtyreg from postransdetail where IdtPosTransaction = '+
          #10''+AnsiQuotedStr(IntToStr(ObjCurrentTicket.IdtPOSTransaction),'''')+
          #10'AND IdtCheckOut='+ AnsiQuotedStr(IntToStr(ObjCurrentTicket.IdtCheckOut),'''')+
          #10'AND DatTransbegin ='+AnsiQuotedStr(DatTransbegin,'''')+
          #10'And IdtArticle = ' +AnsiQuotedStr(ObjCurrentTrans.IdtArticle,'''')+
          #10' AND ValInclVAT < 0 and CodAction = 1' ) ;
      if ObjCurrentTrans.ValInclVAT > 0 then
       QryRemisePerso.SQL.Add('select  Numlinereg, Qtyreg from postransdetail where IdtPosTransaction = '+
          #10''+AnsiQuotedStr(IntToStr(ObjCurrentTicket.IdtPOSTransaction),'''')+
          #10'AND IdtCheckOut='+ AnsiQuotedStr(IntToStr(ObjCurrentTicket.IdtCheckOut),'''')+
          ...
          #10'And IdtArticle = ' +AnsiQuotedStr(ObjCurrentTrans.IdtArticle,'''')+
          #10' AND ValInclVAT > 0 and CodAction = 1' );
      QryRemisePerso.Active := True;
      while not QryRemisePerso.Eof do begin
        QtyTotalReturn  := QtyTotalReturn + QryRemisePerso.FieldByName('qtyreg').AsFloat;
        QryRemisePerso.Next;
      end;
      if  QtyTotalReturn <> StrToFloat(TxtQtyArt) then begin
       QryRemisePerso.First;
       while not QryRemisePerso.Eof do begin
        QryRemisePersoTotal.Close;
        QryRemisePersoTotal.SQL.Clear;
        QryRemisePersoTotal.SQL.Add('select  sum(PrcInclVAT) as TotPrice, sum(valinclvat) as TotVal from postransdetail where IdtPosTransaction = '+
          #10''+AnsiQuotedStr(IntToStr(ObjCurrentTicket.IdtPOSTransaction),'''')+
          #10'AND IdtCheckOut='+ AnsiQuotedStr(IntToStr(ObjCurrentTicket.IdtCheckOut),'''')+
          #10'AND DatTransbegin ='+AnsiQuotedStr(DatTransbegin,'''')+'and CodType in(412,11)' +
          #10'And numlinereg > '+IntToStr(NumLineRegTemp)+'and numlinereg = ' +QryRemisePerso.FieldByName('NumLineReg').AsString ) ;
        QryRemisePersoTotal.Active := True;
        if (NumLineRegTemp < QryRemisePerso.FieldByName('NumLineReg').AsInteger) then
         NumLineRegTemp  := QryRemisePerso.FieldByName('NumLineReg').AsInteger ;
        QryRemisePerso.Next;
        RemisePersoTotal := QryRemisePersoTotal.FieldByName('TotPrice').AsFloat-QryRemisePersoTotal.FieldByName('TotVal').AsFloat;
        if NumLineRegTemp > NumLineRegPrevious then begin
           NumLineRegPrevious := NumLineRegTemp;
           break;
        end;
       end;
      end
       ...
       while not QryRemisePerso.Eof do begin
        ...
        QryRemisePersoTotal.SQL.Add('select  sum(PrcInclVAT) as TotPrice, sum(valinclvat) as TotVal from postransdetail where IdtPosTransaction = '+
          ...
          #10'And numlinereg > '+IntToStr(NumLineRegTemp)+'and numlinereg = ' +QryRemisePerso.FieldByName('NumLineReg').AsString ) ;
        QryRemisePersoTotal.Active := True;
        RemisePersoTotal :=RemisePersoTotal+ QryRemisePersoTotal.FieldByName('TotPrice').AsFloat-QryRemisePersoTotal.FieldByName('TotVal').AsFloat;
        QryRemisePerso.Next;
       end;
      end;
      QryRemisePerso.Close;
    ...
    if FlgEmplCard then begin
      Result := ObjCurrentTrans.IdtArticle + SepCol +
              ...
              CurrToStrF (ObjCurrentTrans.ValInclVAT, ffFixed,
                          DmdFpnUtils.QtyDecsPrice) + SepCol +
              CurrToStrF (-(RemisePersoTotal), ffFixed,
                          DmdFpnUtils.QtyDecsPrice) + SepCol +
              CurrToStrF (ObjCurrentTrans.ValInclVAT-RemisePersoTotal, ffFixed,
                          DmdFpnUtils.QtyDecsPrice) + SepCol +
              IntToStr (ObjCurrentTrans.IdtVATCode)
    end
    else if FlgClientIntracom then
...
begin  // of TFrmVSRptInvoiceCA.CalcBodyDetailLine
  case ObjCurrentTrans.CodMainAction of
    ...
    CtCodActClassNum,
    CtCodActGiftCard,
    CtCodErrGiftCard, //R2011.2 Defect 448 TCS SMB
...
begin  // of TFrmVSRptInvoiceCA.BuildBodyDetailLine
  ...
  case ObjCurrentTrans.CodMainAction of
    ...
    CtCodErrGiftCard       : PrintBodyDetailLine; //R2011.2 Defect 448 TCS SMB
    CtCodActDiscPers       : if not FlgItaly then PrintBodyDetailAdmin;
  ...
  if (ObjCurrentTrans.CodActComment <> 0) then begin
    if TObjTransactionCA(ObjCurrentTrans).CodType = CtCodPdtCommentDocBoPV_Fichier then
     ...
     and not((TObjTransactionCA(ObjCurrentTrans).CodTypeMOB = CtCodPdtCommentMOBTaxArticle))    //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM
    ...
    //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start :::
    else if (TObjTransactionCA(ObjCurrentTrans).CodTypeMOB = CtCodPdtCommentMOBTaxArticle)
      and not (TObjTransactionCA(ObjCurrentTrans).CodTypeD3E = CtCodPdtCommentEcoTaxArticle)
       and (ObjCurrentTrans.QtyArt <> 0) then begin
      if FlgShowMOBTaxInvoiceLine then begin                                  
        PrintLineMOBTax;
      end;
    end
    else if (TObjTransactionCA(ObjCurrentTrans).CodTypeD3E = CtCodPdtCommentEcoTaxArticle)
       and (ObjCurrentTrans.QtyArt <> 0) then begin
        flgECOTax := True;
        PrintLineBothEcoTax;
     if (TObjTransactionCA(ObjCurrentTrans).CodTypeMOB = CtCodPdtCommentMOBTaxArticle)
       and (ObjCurrentTrans.QtyArt <> 0) then begin
        flgMOBTax := True;
        PrintLineBothMOBTax;
      end;
    ...
    //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End :::
      ...
      if (TObjTransactionCA(ObjCurrentTrans).CodTypeD3E = CtCodPdtCommentEcoTaxFreeArticle)
      and not(TObjTransactionCA(ObjCurrentTrans).CodTypeMOB = CtCodPdtCommentMOBTaxFreeArticle)     //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM
      and (ObjCurrentTrans.QtyArt <> 0) then begin
      ...
      //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start
      else if (TObjTransactionCA(ObjCurrentTrans).CodTypeMOB =CtCodPdtCommentMOBTaxFreeArticle)
         and not(TObjTransactionCA(ObjCurrentTrans).CodTypeD3E = CtCodPdtCommentEcoTaxFreeArticle)
         and (ObjCurrentTrans.QtyArt <> 0) then begin
        if (FlgShowMOBTaxInvoiceLine) and (FlgShowMOBTaxFreeArt) then begin
         PrintLineMOBTax;
        end;
      end

      else if (TObjTransactionCA(ObjCurrentTrans).CodTypeD3E = CtCodPdtCommentEcoTaxFreeArticle)
       and (ObjCurrentTrans.QtyArt <> 0) then begin
         flgECOFreeTax := True;
         PrintLineBothEcoTax;
       if (TObjTransactionCA(ObjCurrentTrans).CodTypeMOB = CtCodPdtCommentMOBTaxFreeArticle)
         and (ObjCurrentTrans.QtyArt <> 0) then
        if FlgShowEcoTaxInvoiceLine then begin
          flgMOBFreeTax := True;
          PrintLineBothMOBTax;
        end;
  ...
  if ObjCurrentTrans.QtyArt <>  0 then begin
    ...
    //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start ::::
    //Calculate total mobtax for articles
    if TObjTransactionCA(ObjCurrentTrans).CodTypeMOB =
                                        CtCodPdtCommentMOBTaxArticle then begin
      ValTotalMOBTaxArticle := ValTotalMOBTaxArticle +
                               TObjTransactionCA(ObjCurrentTrans).PrcMOB;
    end
    //Calculate total mobtax for free articles
    else if TObjTransactionCA(ObjCurrentTrans).CodTypeMOB =
                                     CtCodPdtCommentMOBTaxFreeArticle then begin
      ValTotalMOBTaxFreeArticle := ValTotalMOBTaxFreeArticle +
                                   TObjTransactionCA(ObjCurrentTrans).PrcMOB;
    end;
    //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End ::::
  end;
...
begin  // of TFrmVSRptInvoiceCA.MakeTotals
  ...
  if not FlgRussia then begin
    ...
    //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start ::::
    if (ValTotalMOBTaxArticle > 0) and FlgShowMOBTaxInvoiceTotal then begin
      TxtLine := Trim(TxtDescrTotInvoiceMOB) + ' ' + CurrToStrF (ValTotalMOBTaxArticle,
                   ffFixed, DmdFpnUtils.QtyDecsPrice) + SepCol + ' ' + SepCol;
      VspPreview.AddTable (TxtTablePaymentFtr, '', TxtLine, False, False, True);
    end; // of if (ValTotalMOBTaxArticle > 0) and FlgShowMOBTaxInvoiceTotal
    if FlgShowMOBTaxInvoiceTotal and FlgShowMOBTaxFreeArt and
       (ValTotalMOBTaxFreeArticle > 0) then begin
      TxtLine := Trim(TxtDescrTotInvoiceFreeMOB) + ' ' + CurrToStrF
                   (ValTotalMOBTaxFreeArticle, ffFixed, DmdFpnUtils.QtyDecsPrice);
      VspPreview.AddTable (TxtTablePaymentFtr, '', TxtLine, False, False, True);
    end; // of if FlgShowMOBTaxInvoiceTotal and FlgShowMOBTaxFreeArt
    //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End ::::
...
var
  TxtInvRemark    : string;
  CntItem         : integer;
  FooterAddress   : string;                                                     //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
begin  // of TFrmVSRptInvoiceCA.PrintRemarqueTable
  //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.START
  if ViFlgCAFR then begin
    ViValRptVATPosY:=10800;
    ViValRptPaymentPosY:=10800;
    ViValRptRemarquePosY:=13200;
    ViValRptRemarqueHeight:=1700;
  end
  else if ViFlgBDFR then begin
    ViValRptVATPosY:=10500;
    ViValRptPaymentPosY:=10500;
    ViValRptRemarquePosY:=12900;
    ViValRptRemarqueHeight:=1900;
  end;
  //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.END
  if FlgFiscal and FlgItaly then begin
    ...
    if not FlgRussia then begin
      ...
      if ViFlgCAFR then begin
        GetFooterInfo;
        VspPreview.TextBox (' ' + FooterTextVAT,
                          ViValRptRemarquePosX, ViValRptRemarquePosY,
                          ViValRptRemarqueWidth, ViValRptRemarqueHeight, True,
                          False, True);
        VspPreview.Font.Style := VspPreview.Font.Style + [fsBold];
        VspPreview.TextBox (#13 + #13 + ' ' + FooterTextPaymentHdr,              //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS(CP)	
                          ViValRptRemarquePosX, ViValRptRemarquePosY,
                          ViValRptRemarqueWidth, ViValRptRemarqueHeight, True,
                          False, True);
        VspPreview.Font.Style := VspPreview.Font.Style - [fsBold];
        VspPreview.TextBox (#13 + #13 + #13 + FooterInformation,                 //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS(CP)
                          ViValRptRemarquePosX, ViValRptRemarquePosY,
                          ViValRptRemarqueWidth, ViValRptRemarqueHeight, True,
                          False, True);
        ...
        GetFooterInfo;
        VspPreview.Font.Style := VspPreview.Font.Style + [fsBold];
        VspPreview.TextBox (' ' + FooterTextPaymentHdr,
                          ViValRptRemarquePosX, ViValRptRemarquePosY,
                          ViValRptRemarqueWidth, ViValRptRemarqueHeight, True,
                          False, True);
        VspPreview.Font.Style := VspPreview.Font.Style - [fsBold];
        VspPreview.TextBox (' ' + #13 + FooterInformation,
                          ViValRptRemarquePosX, ViValRptRemarquePosY,
                          ViValRptRemarqueWidth, ViValRptRemarqueHeight, True,
                          False, True);
      end
...
begin  // of TFrmVSRptInvoiceCA.GetTxtCreditStrip
  ...
  try                                                                           //R2013.2.Req(25020).BRFR-CAFR.Entering Customer Info.TCS-SC
    NumInvExpDays := StrToInt(DmdFpnCustomerCA.InfoCustomer [IdtCustomer,
                                                           CodCreator,
                                                           'NumInvExpDays']);
  //R2013.2.Req(25020).BRFR-CAFR.Entering Customer Info.TCS-SC.Start
...
begin  // of TFrmVSRptInvoiceCA.PrintBodyInvoice
  ...
  ValTotalMOBTaxArticle     := 0;                                               //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End
  ValTotalMOBTaxFreeArticle := 0;                                               //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End
  ValTempNetto              := 0;
  // Intracom Invoice excl. Tax, ARB, R2011.1.EUR5, Start
    ...
    if not FlgRussia then begin
      try
        if DmdFpnUtils.QueryInfo
          ...
          NumQtyCopy:= DmdFpnUtils.QryInfo.FieldByName('QtyCopyInv').AsInteger;
      finally
        DmdFpnUtils.CloseInfo;
      end; // of try... finally
      // if NumCopies < 1 then                                                  //R2013.1 Applix(2730906).Printing invoice problem-JD
        NumCopies := 1;
    end // of if not FlgRussia
    else
      NumCopies := 1;                                                            //R2013.1 Applix(2730906).Printing invoice problem-JD
  //    NumCopies := 2;
      ...
      for CntLstTickets := 0 to Pred (DmdFpnInvoice.LstTickets.Count) do begin
        ...
        do begin
          ...
          if FlgAllowCreditnote and FlgCreditnote then
            InvertCurrentTrans;
          if ((ViFlgCAFR and (ObjCurrentTrans.CodActAdm = CtCodActTakeBackAdvance))  or (Abs (ObjCurrentTrans.ValAdmInclVAT) > 0)) and //R2013.2.Req(31010).CAFR.DocBO_Advance_Payment.TCS-SM
          ...
          if CntCopy = 1 then begin                                             //HPQC.DefectFix(298).TCS-SRM.Start
            CalcBodyDetailLine;
            EvaluatePagePosition;
          end;                                                                  //HPQC.DefectFix(298).TCS-SRM.End
        end;
      end;
    end;
  finally
...
begin  // of TFrmVSRptInvoiceCA.PrintVATTable
  FlgEmplCard := False;                                                         //R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-AJ
  NumLineRegTemp := 0;                                                          //R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-RC
  NumLineRegPrevious := 0;                                                      //R2014.1.HOTFIX(19631).BDFR.Staff-Discount.TCS-RC
...
begin  // of TFrmVSRptInvoiceCA.FormCreate
  ...
  CIFNLogConfig:=ReplaceEnvVar ('%PrgROOT%') + CIFNLogConfig;   //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
...
begin  // of TFrmVSRptInvoiceCA.VspPreviewNewPage
  ...
  if FlgRussia then begin
    ...
    if FlgItaly then
      ...
      //NumBodyRow := 25;                                                       //Applix Bug #2281911 By TCS(SRM)
      NumBodyRow := 26;                                                         //HPQC.DefectFix(298).TCS-SRM
...
begin  // of TFrmVSRptInvoiceCA.ActPrintAllExecute
 ...
 if ( (NumQtyCopy = 1) or ( NumQtyCopy = 0)) then begin                           //R2013.1 Applix(2730906).Printing invoice problem-JD
    AllowPrintActions := False;
    AllowPrintSetupActions := False;
    ActPrintCustom.enabled := False;
 end;
   NumQtyCopy := NumQtyCopy-1 ;                                                   //R2013.1 Applix(2730906).Printing invoice problem-JD
...
begin
  ...
  if ViFlgCAFR then
    PrintHeadOfficeInfo                                                         
  else if ViFlgBDFR and (CodCreator = 4)  then
    PrintBankInfoBDFR;
  //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM.END
end;
...
var
  ...
  NumTotalPages    : Integer;          // all the pages (including copies)
  NumPages         : Integer;          // nr pages for 1 doc (excluding copies)
  NumPage          : Integer;          // R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
begin  // of TFrmVSRptInvoiceCA.MakeOverLay
  NumPage:=1;                                                                   //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM
  NumTotalPages := VspPreview.PageCount;
  if NumTotalPages > 0 then begin
    ...
    for CntPage := 1 to NumTotalPages do begin
      ...
      try
        ...
        MakeCustomInfo;
        //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS-SM::START
        VspPreview.CurrentX := 499.2;
        VspPreview.CurrentY := ViValPageNumberPos;
        VspPreview.Text := CtTxtPage + ':' + IntToStr (NumPage) + '/' +
                                IntToStr (NumPages);
        if NumPage >= NumPages then
          NumPage := 1
        else
...
begin   // of TFrmVSRptInvoiceCA.PrintTotalLine
  VspPreview.CurrentY := ValRptTotalPosY +(ViValRptSpaceBtwRect * 6);                 // R2013.1 Applix(2730906).Printing invoice problem-JD
  VspPreview.TableBorder := tbBoxColumns;
  VspPreview.Font.Style := VspPreview.Font.Style + [fsBold];
  TxtLineTotal :=
...
begin  // of TObjTransactionCA.Count
  ...
  PrcMOB := PrcMOB + TObjTransactionCA(ObjTransaction).PrcMOB;                  //R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM
...
//R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start :::
//=============================================================================
function TFrmVSRptInvoiceCA.GenerateLineMOBTax: string;
begin  // of TFrmVSRptInvoiceCA.GenerateLineMOBTax
  Result := SepCol + ObjCurrentTrans.TxtDescrComment + ' ' +
            CurrToStrF (TObjTransactionCA(ObjCurrentTrans).PrcMOB, ffFixed,
                        DmdFpnUtils.QtyDecsPrice);
end;   // of TFrmVSRptInvoiceCA.GenerateLineMOBTax
//=============================================================================
function TFrmVSRptInvoiceCA.GenerateLineBothECOTax: string;
begin  // of TFrmVSRptInvoiceCA.GenerateLineBothECOTax
   if flgECOTax  and FlgShowEcoTaxInvoiceLine then begin
     Result := SepCol +FTxtDescrArtLine + ' ' +
            CurrToStrF (TObjTransactionCA(ObjCurrentTrans).PrcD3E, ffFixed,
                        DmdFpnUtils.QtyDecsPrice);
     flgECOTax := False;
   end
   ...
   if flgECOFreeTax then
     if FlgShowEcoTaxInvoiceLine and FlgShowEcoTaxFreeArt then begin
       Result := SepCol +FTxtDescrFreeArtLine + ' ' +
            CurrToStrF (TObjTransactionCA(ObjCurrentTrans).PrcD3E, ffFixed,
                        DmdFpnUtils.QtyDecsPrice);
       flgECOFreeTax := False;
     end
       ...
       flgECOFreeTax := False;
end;   // of TFrmVSRptInvoiceCA.GenerateLineBothECOTax
//=============================================================================
function TFrmVSRptInvoiceCA.GenerateLineBothMOBTax: string;
begin  // of TFrmVSRptInvoiceCA.GenerateLineBothMOBTax
   if flgMOBTax and FlgShowMOBTaxInvoiceLine then begin
     Result := SepCol +FTxtDescrArtLineMOB+ ' ' +
            CurrToStrF (TObjTransactionCA(ObjCurrentTrans).PrcMOB, ffFixed,
                        DmdFpnUtils.QtyDecsPrice);
     flgMOBTax := False;
   end
  ...
  if flgMOBFreeTax then
    if FlgShowMOBTaxInvoiceLine and FlgShowMOBTaxFreeArt then begin
      Result := SepCol + FTxtDescrFreeArtLineMOB + ' ' +
            CurrToStrF (TObjTransactionCA(ObjCurrentTrans).PrcMOB, ffFixed,
                        DmdFpnUtils.QtyDecsPrice);
      flgMOBFreeTax :=False;
    end
      ...
      flgMOBFreeTax :=False;
end;   // of TFrmVSRptInvoiceCA.GenerateLineBothMOBTax
//=============================================================================
//R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End :::
//=============================================================================
...
//R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.Start :::
//=============================================================================
procedure TFrmVSRptInvoiceCA.PrintLineMOBTax;
begin  // of TFrmVSRptInvoiceCA.PrintLineEcoTax
  VspPreview.AddTable (TxtTableBodyFmt, '', GenerateLineMOBTax, False,
                       False, True);
  EvaluatePagePosition;
end;   // of TFrmVSRptInvoiceCA.PrintLineMOBTax

//=============================================================================
procedure TFrmVSRptInvoiceCA.PrintLineBothECOTax;
begin  // of TFrmVSRptInvoiceCA.PrintLineEcoTax

  VspPreview.AddTable (TxtTableBodyFmt,'', GenerateLineBothECOTax, False,
                       False, True);
  EvaluatePagePosition;
end;   // of TFrmVSRptInvoiceCA.PrintLineMOBTax
//=============================================================================
procedure TFrmVSRptInvoiceCA.PrintLineBothMOBTax;
begin  // of TFrmVSRptInvoiceCA.PrintLineBothMOBTax

  VspPreview.AddTable (TxtTableBodyFmt,'', GenerateLineBothMOBTax, False,
                       False, True);
  EvaluatePagePosition;
end;   // of TFrmVSRptInvoiceCA.PrintLineBothMOBTax
//=============================================================================
//R2011.2(Adhoc).ID17303.EcoTaxREPMOB.BDFR/CAFR.TCS-SRM.End :::
//=============================================================================
...
begin  // of TFrmVSRptInvoiceCA.PrintArticleNormalLine
  ...
  VspPreview.AddTable (TxtTableBodyFmt, '', GenerateNormalLine (NumLineTotal),
                       False, False, True);
  //EvaluatePagePosition;                                                       //HPQC.DefectFix(298).TCS-SRM
   EvaluatePagePosition;                                                         // R2013.1 Applix(2730906).Printing invoice problem-JD
...
begin  // of TFrmVSRptInvoiceCA.PrintHeader
  ...
  try
    ...
    if FileExists (StrFilePath) then begin
     ...
     //R2013.1 HPQC Defect Fix 120(SM) :: START
     if FlgCreditStrip and FlgClientEnCompte and not FlgCreditnote
     and not FlgClientIntracom then
      VspPreview.DrawPicture (OlePicLogo, VspPreview.PageWidth -
                              VspPreview.MarginLeft - VarPicWidth-3000,
                              VspPreview.CurrentY, '100%', '100%', '', False)
     else
     //R2013.1 HPQC Defect Fix 120(SM) :: END
      VspPreview.DrawPicture (OlePicLogo, VspPreview.PageWidth -
...
procedure TFrmVSRptInvoiceCA.PrintHeadOfficeInfo;
var
TxtHeadOAddress1  : string;
TxtHeadOAddress2  : string;
TxtHeadOCapital   : string;
TxtHeadOLabelHO   : string;
TxtHeadOName      : string;
TxtHeadORegister  : string;
TxtHeadOStatusHO  : string;
TxtLine1          : string;
TxtLine2          : string;
begin
  try
    if DmdFpnUtils.QueryInfo(
      #10'SELECT IdtApplicParam,TxtParam FROM ApplicParam' +
      #10'WHERE IdtApplicParam in' +
      #10'(''HeadOAddress1'',''HeadOAddress2'',''HeadOCapital'',''HeadOLabelHO'',''HeadOName'',''HeadOregister'',''HeadOStatusHO'')')  then begin
      with DmdFpnUtils.QryInfo do begin
        if Locate ('IdtApplicParam','HeadOAddress1',[loCaseInsensitive]) then
          TxtHeadOAddress1 := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','HeadOAddress2',[loCaseInsensitive]) then
          TxtHeadOAddress2 := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','HeadOCapital',[loCaseInsensitive]) then
          TxtHeadOCapital := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','HeadOLabelHO',[loCaseInsensitive]) then
          TxtHeadOLabelHO := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','HeadOName',[loCaseInsensitive]) then
          TxtHeadOName := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','HeadORegister',[loCaseInsensitive]) then
          TxtHeadORegister := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','HeadOStatusHO',[loCaseInsensitive]) then
          TxtHeadOStatusHO := FieldByName ('TxtParam').AsString;
      end;
    end;
  finally
    DmdFpnUtils.ClearQryInfo;
  ...
  TxtHeadOCapital:=AddThousandSeparator(TxtHeadOCapital,' ');
  TxtHeadOStatusHO:=StringReplace(TxtHeadOStatusHO,'XXX',TxtHeadOCapital,[rfReplaceAll, rfIgnoreCase]);
  TxtLine1:= TxtHeadOLabelHO + TxtHeadOName + '-' + TxtHeadOStatusHO;
  TxtLine2:= TxtHeadOAddress1 + ' ' + TxtHeadOAddress2;
  VspPreview.CurrentX := ((VspPreview.PageWidth) - (TextWidthInTwips(TxtLine1 )))/2;
  VspPreview.CurrentY := ViValRptRemarquePosY + ViValRptRemarqueHeight + ViValRptSpaceBtwRect;
  VspPreview.Text:= TxtLine1 + CRLF ;
  VspPreview.CurrentX := ((VspPreview.PageWidth) - (TextWidthInTwips(TxtLine2)))/2;
  VspPreview.Text:= TxtLine2 + CRLF;
  VspPreview.CurrentX := ((VspPreview.PageWidth) - (TextWidthInTwips(TxtHeadORegister)))/2;
  VspPreview.Text:= TxtHeadORegister;
end;
//=============================================================================
procedure TFrmVSRptInvoiceCA.PrintBankInfoBDFR;
var
TxtBankInfo1  : string;
TxtBankInfo2  : string;
TxtBankAccNum : string;
BankInfo      : string;
begin
  try
    if DmdFpnUtils.QueryInfo(
      #10'SELECT IdtApplicParam,TxtParam FROM ApplicParam' +
      #10'WHERE IdtApplicParam in' +
      #10'(''TxtBankInfo1'',''TxtBankInfo2'',''TxtBankAccNum'')')  then begin
      with DmdFpnUtils.QryInfo do begin
        if Locate ('IdtApplicParam','TxtBankInfo1',[loCaseInsensitive]) then
          TxtBankInfo1 := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','TxtBankInfo2',[loCaseInsensitive]) then
          TxtBankInfo2 := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','TxtBankAccNum',[loCaseInsensitive]) then
          TxtBankAccNum := FieldByName ('TxtParam').AsString;
      end;
    end;
  finally
    DmdFpnUtils.ClearQryInfo;
  ...
  TxtBankInfo2:=StringReplace(TxtBankInfo2,'XXXXXX',TxtBankAccNum,[rfReplaceAll, rfIgnoreCase]);
  //R2013.2.ALM Defect 62.Req(31170).CAFR/BDFR.Legal Information On Invoices.TCS-JD.Start
  if (not FlgClientIntracom) then begin                                           //R2013.2.Enhancement 138.TCS-MeD
  VspPreview.CurrentX := ((VspPreview.PageWidth) - (TextWidthInTwips(TxtBankInfo1 )))/2;
  VspPreview.CurrentY := ViValRptRemarquePosY + ViValRptRemarqueHeight + ViValRptSpaceBtwRect;
  VspPreview.Text:= TxtBankInfo1 + CRLF ;                                                               
  VspPreview.CurrentX := ((VspPreview.PageWidth) - (TextWidthInTwips(TxtBankInfo2 )))/2;
  VspPreview.Text:= TxtBankInfo2 + CRLF ;
  end                                                                            //R2013.2.Enhancement 138.TCS-MeD
  //R2013.2.ALM Defect 62.Req(31170).CAFR/BDFR.Legal Information On Invoices.TCS-JD.End
  //VspPreview.Text:=  ' ' + #13 + TxtBankInfo2;
end;
//=============================================================================
function TFrmVSRptInvoiceCA.AddThousandSeparator(S: string; Chr: Char): string;
var
  I: Integer;
begin
  Result := S;
...
//=============================================================================
procedure TFrmVSRptInvoiceCA.GetFooterInfo;
var
  FooterTextLegal1               : string;
  FooterTextLegal2               : string;
  FooterTextJuridicial           : string;                                      
  FooterTextCont                 : string;						//R2013.2.ALM Defect Fix 134.CAFR.MeD.TCS
  FooterTxtJdclVal               : string;
  FooterTextDebt                 : string;
  FooterTextDebtValue            : string;
  FooterTextAddpayment           : string;
...
begin
  try
    if DmdFpnUtils.QueryInfo(
      #10'SELECT IdtApplicParam,TxtParam FROM ApplicParam' +
      #10'WHERE IdtApplicParam in' +
      #10'(''FooterTextLegal1'',''FooterTextLegal2'',''FooterTextJuridicial'',''FooterTextCont'',''FooterTxtJdclVal'',''FooterTextDebt'',''FooterTextDebtValue'',''FooterTextVAT'',''FooterTextPaymentHdr'',''FooterTextAddpayment'')')  then begin                 //added FooterTextCont R2013.2.ALM Defect Fix 134.CAFR.MeD.TCS
      with DmdFpnUtils.QryInfo do begin
        if Locate ('IdtApplicParam','FooterTextLegal1',[loCaseInsensitive]) then
          FooterTextLegal1 := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','FooterTextLegal2',[loCaseInsensitive]) then
          FooterTextLegal2 := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','FooterTextJuridicial',[loCaseInsensitive]) then
          FooterTextJuridicial := FieldByName ('TxtParam').AsString;
        //R2013.2.ALM Defect Fix 134.CAFR.MeD.TCS.Start
        if Locate ('IdtApplicParam','FooterTextCont',[loCaseInsensitive]) then
          FooterTextCont := FieldByName ('TxtParam').AsString;
        //R2013.2.ALM Defect Fix 134.CAFR.MeD.TCS.End
        if Locate ('IdtApplicParam','FooterTxtJdclVal',[loCaseInsensitive]) then
          FooterTxtJdclVal := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','FooterTextDebt',[loCaseInsensitive]) then
          FooterTextDebt := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','FooterTextDebtValue',[loCaseInsensitive]) then
          FooterTextDebtValue := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','FooterTextVAT',[loCaseInsensitive]) then
          FooterTextVAT := FieldByName ('TxtParam').AsString;
        if Locate ('IdtApplicParam','FooterTextPaymentHdr',[loCaseInsensitive]) then
          FooterTextPaymentHdr := FieldByName ('TxtParam').AsString;
        if ViFlgBDFR and (CodCreator = 4) then begin                        //R2013.2.ALM Defect 60.Req(31170).CAFR/BDFR.Legal Information On Invoices.TCS-JD
          if Locate ('IdtApplicParam','FooterTextAddpayment',[loCaseInsensitive]) then
          FooterTextAddpayment := FieldByName ('TxtParam').AsString;
        end;
      end;
    end;
  finally
  ...
  if ViFlgBDFR and (CodCreator = 4) then begin                              //R2013.2.ALM Defect 60.Req(31170).CAFR/BDFR.Legal Information On Invoices.TCS-JD
    FooterAddress:=DmdFpnTradeMatrix.InfoTradeMatrix
                                             [DmdFpnUtils.IdtTradeMatrixAssort,
                                             'TxtStreet'] + #13 + ' ' +                                //R2013.2.Req(31170).CAFR/BDFR.Legal_Information_On_Invoices.TCS(CP)
                   DmdFpnTradeMatrix.InfoTradeMatrix
                                             [DmdFpnUtils.IdtTradeMatrixAssort,
                                             'TxtCodPost'] + ' ' +
                   DmdFpnTradeMatrix.InfoTradeMatrix
                                             [DmdFpnUtils.IdtTradeMatrixAssort,
                                             'TxtMunicip'] + #13;
  end;                        //R2013.2.ALM Defect 60.Req(31170).CAFR/BDFR.Legal Information On Invoices.TCS-JD
  //R2013.2.Defect134/197.CAFR.LegalInfoinInvoice.TCS-CP.Start
  if ViFlgBDFR then
    FooterTextJuridicial:=StringReplace(FooterTextJuridicial,'#',FooterTxtJdclVal,[rfReplaceAll, rfIgnoreCase]);
  if ViFlgCAFR then
    FooterTextCont:=StringReplace(FooterTextCont,'#',FooterTxtJdclVal,[rfReplaceAll, rfIgnoreCase]);
  //R2013.2.Defect134/197.CAFR.LegalInfoinInvoice.TCS-CP.End
  FooterTextDebt:=StringReplace(FooterTextDebt,'#',FooterTextDebtValue,[rfReplaceAll, rfIgnoreCase]);
  if ViFlgCAFR then
    FooterInformation:=' ' + FooterTextLegal1 + #13 + ' ' + FooterTextLegal2 + #13 + ' ' + trim(FooterTextJuridicial)
           + #13 + ' ' + FooterTextCont + #13 + ' ' + FooterTextDebt             //R2013.2.ALM Defect Fix 134.CAFR.MeD.TCS
  else if ViFlgBDFR then
    FooterInformation:=' ' + FooterTextLegal1 + #13 + ' ' + FooterTextJuridicial 
           + #13 + ' ' + FooterTextAddpayment + #13 + ' ' + FooterAddress + #13 + ' ' + FooterTextDebt + #13 + ' ';
end;
//=============================================================================
function TFrmVSRptInvoiceCA.GetFileModDate(filename : string) : TDateTime;
var
  F : TSearchRec;
begin
