...
// CVS      : $Header: /development/Castorama/Flexpoint/Src/Flexpoint201/Develop/FVSRptTndCountCA.pas,v 1.20 2011/12/05 14:39:28 TCS\SMB Exp $
// History  :
// - Started from Castorama - FlexPoint 2.0 - PRptGlobalCount - CVS revision 1.22
// Version           Modified By              Reason
// V 1.22            Teesta(TCS)              Internal defect_83 fix (test cycle 2), R2012.1, CAFR 
//=============================================================================

unit FVSRptTndCountCA;
...
const  // IdtTenderGroups
  ...
  CtCodErrorCarteCadeaux     = 166;        // Carte Cadeaux Error               //TCS SMB DEFECT 248 & 277
...
const  // PVCS-keywords
  ...
  CtTxtSrcVersion = '$Revision: 1.22 $';
  CtTxtSrcDate    = '$Date: 2011/12/05 14:39:28 $';
  ...
  for CntPage := 1 to VspPreview.PageCount do begin
    ...
    try
      ...
      VspPreview.CurrentY := VspPreview.PageHeight - VspPreview.MarginBottom +
                             VspPreview.TextHeight ['X'];                 //Internal defect_83 fix (test cycle 2), R2012.1, CAFR, Teesta(TCS)
...
begin  // of TFrmVSRptTndCountCA.BuildCarteCadeaux
  ...
  #10'  AND Det1.CodTrans = Act.CodTrans' +
  #10'  AND Det1.DatTransBegin = Act.DatTransBegin' +
  #10'WHERE Det1.CodAction in (' + IntToStr(CtCodCarteCadeaux) + ',' + IntToStr(CtCodErrorCarteCadeaux) + ')';//TCS SMB DEFECT 248 & 277
