inherited FrmDetCatalogueInput: TFrmDetCatalogueInput
  Left = 471
  Top = 210
  Width = 468
  Height = 195
  Caption = 'catalogue Input Report'
  OnPaint = FormPaint
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object SprCACatalogueInput: TStoredProc
    DatabaseName = 'DBFlexPoint'
    StoredProcName = 'SprCACatalogueInput;1'
    Left = 256
    Top = 232
    ParamData = <
      item
